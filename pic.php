...
$text = "Поздравляю!".PHP_EOL."Вы прошли тест!".PHP_EOL."Данный сертификат удостоверяет, что".PHP_EOL.$_SESSION['fio'].PHP_EOL. "прошел(шла) тест с результатом".PHP_EOL.$_SESSION['res']."%";
$_SESSION['text'] = $text;
...
$boxfile = '../forms_pictures/picture.png';
...
$fontfile = '../forms_pictures/a_Alterna.ttf';
